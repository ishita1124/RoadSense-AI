...
function AccidentExplorer() {
  ...
  const loadAccidents = async (
    ...
    try {
      ...
      console.error(
        "Accident records loading failed:",
        err
      );
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex items-end gap-2">
            ...
            <button
              ...
              title="Reset filters"
              disabled={loading}
              className="inline-flex items-center justify-center rounded-xl border border-slate-200 bg-white p-2.5 text-slate-600 transition hover:bg-slate-50 disabled:opacity-50"
            >
          ...
          <div className="flex min-h-[350px] items-center justify-center">
            ...
            <div className="text-center">
              ...
              <p className="mt-1 text-sm text-slate-500">
                ...
                Fetching accident records from the
                RoadSense AI database.
                    ...
                    (accident) => (
                      ...
                      >
                        ...
                        <td className="px-5 py-4">
                          ...
                          <span
                            className={`inline-flex items-center gap-1 rounded-full px-3 py-1 text-xs font-bold ${getSeverityClass(
